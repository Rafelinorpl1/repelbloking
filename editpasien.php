                    ...
                    <form action="koneksi.php" method="POST"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="jk" value="Perempuan" <?php if (($row['jk']) === 
                                "Perempuan") {
                                    echo "checked";
                                }?>>Perempuan
                            </div>
                        ...
                        <div class="form-group mt-3">
                            <input type="submit" name="edit" value="Simpan" class="fomr-control btn btn-primary">
                        </div>
                    </form>
                    <?php } ?>
                </div>
